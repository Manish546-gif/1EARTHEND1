      ...
      <div className="max-w-8xl mx-auto md:mb-10 px-6 md:mt-10 lg:mt-10 mt-0 lg:px-8 h-screen flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 w-full items-center">
          ...
          <div className="space-y-8 lg:space-y-52">
            <div className="text-[clamp(10px,1vw,14px)] tracking-[0.3em]">
              NEXT PROJECT
            </div>

            <div>
              <h1 className="font-normal leading-[1.05] text-[clamp(28px,4vw,90px)] uppercase text-gray-900 sm:text-4xl">
            ...
            <div>
              <button
                disabled
                className="relative overflow-hidden bg-gray-400 cursor-not-allowed text-white px-6 py-3 rounded-full text-[clamp(12px,1vw,16px)] font-medium transition-colors duration-200 group"
              >
          ...
          <div className="relative w-full">
            <motion.div className="aspect-[4/3] lg:aspect-[1] relative overflow-hidden w-full">
              ...
              <div className="w-full h-full overflow-hidden">
                <img src={nextp} alt="" className="w-full h-full object-cover" />
              </div>
            </motion.div>
          </div>
